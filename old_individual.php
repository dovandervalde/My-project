...
<form action="server_oldpatient.php" method="POST">
...
<input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="(Apelyedo)" name="Lastname" value="<?php echo $_SESSION['Lastname']; ?>" readonly></td>
 <?php endif ?>

 <?php  if (isset($_SESSION['Firstname'])) : ?>
    <td><label><b>First Name:</b></label>
<input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="(Pangalan)" name="Firstname" value="<?php echo $_SESSION['Firstname']; ?>" readonly></td>
<?php endif ?>

<?php  if (isset($_SESSION['Middlename'])) : ?>
    <td><label><b>Middle Name:</b></label>
<input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="(Gitnang Pangalan)" name="Middlename" value="<?php echo $_SESSION['Middlename']; ?>" readonly></td>
<?php endif ?>
  </tr>
...
<input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="(e.g,Jr.,Sr.,II,III)" name="Suffix" value="<?php echo $_SESSION['Suffix']; ?>" readonly></td>
<?php endif ?>

    <td><label><b>Age:</b></label>
<input class="w3-input w3-border w3-margin-bottom" type="number" placeholder="(Age)" name="Age" required></td>

<?php  if (isset($_SESSION['Res_address'])) : ?>
    <td><label><b>Residential Address:</b></label>
<input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="(Tirahan)" name="Residential_Address" value="<?php echo $_SESSION['Res_address']; ?>" readonly>
</td>
<?php endif ?>
  </tr>
...
<b style="margin-left: %">
   ...
   <td>
    ...
    <label><b>Reffered from:</b></label>
        <input class="w3-input w3-border" type="text" placeholder="Reffered from"name="Reffered_from" required></td>
      </tr>
   <tr>
      ...
      <td>
        <label><b>Reffered to:</b></label>
            <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="Reffered to"name="Reffered_to" required>
      </td>
      </tr>
        ...
        <td>
         ...
         <div class="form-group">
            <label for="comment">Comment:</label>
             <textarea name="Reason_for_Referral" class="form-control" rows="5" id="comment" required></textarea>
          </div>
        </td>
...
<input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="Reffered by"name="Reffered_by" required>
