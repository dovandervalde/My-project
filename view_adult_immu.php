...
<div class="w3-container" style="width: 100%">
  <div class="header " style="background-color: ; padding: 5px; width: 100%; color: gray; letter-spacing: 4px;">
    <h2 style="float: left;"><center>View Adult Immunization Records</center></h2>
...
<?php
 ...
 $query = "SELECT * FROM adult_immunization WHERE consultation_purpose = 'Adult Immunization'";
    ...
    <tr class="del<?php echo $id ?>" >
      ...
      <td style="color: #099ca5"><?php echo $row['done_consult']; ?></td>
      ...
      $('#p<?php echo $id; ?>').popover('hide')
        ...
        <a class="btn btn-default"  id="e<?php echo $id; ?>" data-content="Click here to Edit Employee" rel="popover" data-original-title="Edit?"  href="view_adult_immu_record.php<?php echo '?id='.$id; ?>"><i class="icon-file icon-large"></i>&nbsp;View Info</a>&nbsp;


   <a class="btn btn-info"  id="a<?php echo $id; ?>" data-content="Click here to Edit Employee" rel="popover" data-original-title="Edit?"  href="edit_adult_immu_record.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i> Update</a>&nbsp;
