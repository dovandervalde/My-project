...
<h4 style="margin-top: 0px; color: white; letter-spacing: 5px; background-color: #099ca5; padding: 41px" class="w3-card-4 w3-round"><center>Administrator</center></h4>
  ...
  <div class="w3-accordion">
    ...
    <div id="demoAcct" class="w3-accordion-content w3-white w3-card-4">
      ...
      <a href="add_stock.php" style="background-color: #099ca5; color: white" class="w3-round w3-card-4">Add Stock</a>
...
<br />
  ...
  <div class="header">
		<h2><center>Add Stock Medicine</center></h2>
	</div>

	<form action="server_add_stock.php" method="POST">
...
<br />
		...
		<div class="input-group">
		 ...
		 <select class="w3-select w3-border w3-round" name="medicine" required>
        <option disabled selected>Select Medicine</option>
			<?php 
            include_once("dbcon.php");

            $query = mysql_query("SELECT medicine FROM stock_update ORDER BY medicine");
		...
		<div class="input-group">
			<label>Quantity</label>
				<select name="quantity" class="w3-select w3-border w3-round" required>
