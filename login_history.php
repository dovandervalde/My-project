...
<header class="w3-containerw w3-round w3-card-4 w3-padding-30 w3-padding-jumbo" style="background-color: #099ca5; color: white">
  <h1 class="w3-xxlarge w3-padding-" style="letter-spacing: 3px">Login History</h1>
</header>
...
<div class="w3-container" style="width: 50%">
  <div class="header " style="background-color: ; padding: 5px; width: 100%; color: gray; letter-spacing: 4px;">
    <h2 style="float: left;"><center> View Login History</center></h2>
...
<?php
 ...
 $query = "SELECT * FROM history ";
    ...
    <tr class="del<?php echo $id ?>" >
      <td style="padding-left: 5%"><?php echo $row['username']; ?></td>
      <td style="padding-left: 5%"><?php echo $row['dates']; ?></td>
