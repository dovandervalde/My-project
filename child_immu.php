...
<div class="w3-container" style="width: 100%">
  <div class="header " style="background-color: ; padding: 5px; width: 100%; color: gray; letter-spacing: 4px;">
    ...
    <h2 style="float: right; "><button class="w3-btn w3-round" style="background-color: #099ca5; color: white; font-size: 15px; margin-bottom: 10px; padding: 10px; letter-spacing: 3px"><a href="view_child_immu.php" style="color: white">View Records</a></button></h2>
  </div>
  <br />
...
<?php
 ...
 $query = "SELECT * FROM old_patient WHERE Consultation_Purpose = 'Child Immunization' AND num = '0'";
   ...
   <a class="btn btn-info"  id="a<?php echo $id; ?>" data-content="Click here to Edit Employee" rel="popover" data-original-title="Edit?"  href="child_immu_record.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i> Consult</a>&nbsp;
