...
<form action="server_family_planning.php" method="post">
...
<table>
  ...
  <tr>
    ...
    <td><input type="text" name="type_client" style="width: 100%"></td>
  </tr>
   <tr>
    <td>Method</td>
    <td><input type="text" name="method"style="width: 100%"></td>
  </tr>
   <tr>
    <td>Drop-out state reason</td>
    <td><input type="text" name="drop_out"style="width: 100%"></td>
  </tr>
   <tr>
    <td>Schedule of next visit</td>
    <td><input type="text" name="schedule_nxt_vist"style="width: 100%"></td>
  </tr>
