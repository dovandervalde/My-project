...
<h4 style="margin-top: 0px; color: white; letter-spacing: 5px; background-color: #099ca5; padding: 41px" class="w3-card-4 w3-round"><center>Administrator</center></h4>
  ...
  <a href="patient_enrollment_record.php" style="background-color: #099ca5; color: white" class="w3-round w3-card-4">Patient Enrollment Record</a>
...
<header class="w3-container w3-round w3-card-4 w3-padding-25 w3-padding-jumbo" style="background-color: #099ca5; color: white">
  <h2 class="w3-xxlarge w3-padding-" style="font-family: calibri; letter-spacing: 3px">Patient Enrollment Record</h1>
</header>
...
<?php $query = "SELECT * FROM ad_patient";
      ...
      <td><?php echo $row['Dates']; ?></td>
			...
			<a class="btn btn-default"  id="e<?php echo $id; ?>" data-content="Click here to Edit Employee" rel="popover" data-original-title="Edit?"  href="view_patient_record.php<?php echo '?id='.$id; ?>"><i class="icon-file icon-large"></i>&nbsp;View Info</a>&nbsp;

            <a class="btn btn-info"  id="a<?php echo $id; ?>" data-content="Click here to Edit Employee" rel="popover" data-original-title="Edit?"  href="edit_enrollment_record.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i> Update</a>&nbsp;
