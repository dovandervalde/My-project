...
<header class="w3-containerw w3-round w3-card-4 w3-padding-30 w3-padding-jumbo" style="background-color: #099ca5; color: white">
  <h1 class="w3-xxlarge w3-padding-" style="letter-spacing: 3px">Create Admin Account</h1>
</header>
...
<br />
		...
		<div class="input-group">
			...
			<input type="text" name="username" value="<?php echo $username; ?>" class="w3-input" style="padding: 18px">
		</div>
		<div class="input-group">
			<label>Email</label>
			<input type="email" name="email" value="<?php echo $email; ?>" class="w3-input" style="padding: 18px">
		</div>
		<div class="input-group">
			<label>Password</label>
			<input type="password" name="password_1" class="w3-input" style="padding: 18px">
		</div>
		<div class="input-group">
			<label>Confirm password</label>
			<input type="password" name="password_2" class="w3-input" style="padding: 18px">
		</div>
		<br />
		<div class="input-group">
			<button type="submit" class="w3-btn w3-border w3-round" name="reg_user" style="padding: 8px; background-color: #099ca5; color: white">Create Account</button>
		</div>
