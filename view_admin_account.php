  ...
  <div class="w3-accordion">
   ...
   <div class="w3-dropdown-click">
    ...
    <div id="demoDrop" class="w3-dropdown-content w3-white w3-card-4">
      ...
      <a href="view_admin_account.php" style="background-color: #099ca5; color: white" class="w3-round w3-card-4">View Account</a>
    </div>
  </div>
...
<header class="w3-containerw w3-round w3-card-4 w3-padding-30 w3-padding-jumbo" style="background-color: #099ca5; color: white">
  <h1 class="w3-xxlarge w3-padding-" style="letter-spacing: 3px">List of Admin Accounts</h1>
</header>
...
<br />
	...
	<div class="w3-card-4 w3-white w3-round w3-container w3-padding-jumbo" style="margin-left: 3%; max-width:1000px;">

  <div class="header">
		<h2><center>View Accounts</center></h2>
    <h4 style="float: right; color: grey">Active now: ( <?php echo $_SESSION['username']; ?> )</h3>
	</div>
  <br />
<table>
  <tr>
  ...
  <tr>
     <?php
        include('server.php');
        $result = mysqli_query("SELECT * FROM admin ORDER BY dates ASC");
