...
<form action="server_adult_immu.php" method="post">
...
<table>
  ...
  <tr>
    <td>Pnnumcoccool</td>
    <td><input type="text" name="PNL" style="width: 100%" required></td>
  </tr>
   <tr>
    <td>FL</td>
    <td><input type="text" name="FL"style="width: 100%"></td>
  </tr>
   <tr>
    <td>others:</td>
...
<select name="num" style="width: 0px; height: 0px; color: white; opacity: .8">
